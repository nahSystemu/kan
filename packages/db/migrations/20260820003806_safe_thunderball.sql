...
CREATE INDEX IF NOT EXISTS "page_workspace_slug_idx" ON "page" USING btree ("workspaceId","slug");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "unique_page_slug_global" ON "page" USING btree ("slug") WHERE "page"."deletedAt" IS NULL;--> statement-breakpoint
-- Grant role:* permissions to existing system roles
